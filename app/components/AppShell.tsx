...
export default function AppShell({
  ...
  return (
    <main className="min-h-screen bg-[#f4f8ff]">
        ...
        <header className="sticky top-0 z-30 border-b border-blue-100 bg-white/90 backdrop-blur-xl lg:hidden">
          <div className="flex items-center justify-between gap-3 px-4 py-3">
            ...
            <form action="/api/auth/logout" method="post">
              <button className="rounded-2xl bg-blue-950 px-3 py-2 text-xs font-black text-white shadow-lg shadow-blue-950/20">
                Logout
              </button>
            </form>
          </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-blue-100 bg-white/95 px-3 pb-3 pt-2 shadow-2xl shadow-blue-950/10 backdrop-blur-xl lg:hidden">
        <div className="grid grid-cols-5 gap-2">
          <MobileNavItem href="/dashboard" label="Home" icon={<HomeIcon />} />
          <MobileNavItem href="/tasks/new" label="Add" icon={<PlusIcon />} />
          <MobileNavItem href="/tasks" label="Records" icon={<SearchIcon />} />
          <MobileNavItem
            href="/yaumiyya"
            label="Yaumiyya"
            icon={<NotesIcon />}
...
function MobileNavItem({
  ...
  return (
    <Link
      href={href}
      className="flex flex-col items-center justify-center rounded-2xl px-1 py-2 text-slate-500 transition hover:bg-blue-50 hover:text-blue-700"
    >
      <span className="flex h-8 w-8 items-center justify-center rounded-2xl bg-blue-50 text-blue-700">
        {icon}
      </span>
      <span className="mt-1 text-[10px] font-black leading-none">{label}</span>
    </Link>
  );
}
...
function SettingsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M19.4 15a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06A1.7 1.7 0 0 0 15 19.4a1.7 1.7 0 0 0-1 .6 1.7 1.7 0 0 0-.4 1.1V21a2 2 0 0 1-4 0v-.09A1.7 1.7 0 0 0 8 19.4a1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.7 1.7 0 0 0 3.6 15a1.7 1.7 0 0 0-.6-1 1.7 1.7 0 0 0-1.1-.4H2a2 2 0 0 1 0-4h.09A1.7 1.7 0 0 0 3.6 8a1.7 1.7 0 0 0-.34-1.87l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.7 1.7 0 0 0 8 3.6a1.7 1.7 0 0 0 1-.6 1.7 1.7 0 0 0 .4-1.1V2a2 2 0 0 1 4 0v.09A1.7 1.7 0 0 0 15 3.6a1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.7 1.7 0 0 0 19.4 8c.17.37.4.7.7 1 .3.3.63.53 1 .7H21a2 2 0 0 1 0 4h-.09a1.7 1.7 0 0 0-1.51 1.3Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
function DatabaseIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path
        d="M12 3c5 0 9 1.8 9 4s-4 4-9 4-9-1.8-9-4 4-4 9-4Z"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path
        d="M3 7v5c0 2.2 4 4 9 4s9-1.8 9-4V7M3 12v5c0 2.2 4 4 9 4s9-1.8 9-4v-5"
        stroke="currentColor"
        strokeWidth="2"
      />
    </svg>
